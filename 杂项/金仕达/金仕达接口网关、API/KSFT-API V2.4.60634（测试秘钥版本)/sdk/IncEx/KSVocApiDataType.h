...
namespace KingstarAPI
{
	...
	typedef char TKSOrderPriceType;
	...
	/////////////////////////////////////////////////////////////////////////
	///TThostFtdcMoneyRatioType是一个保证金比例类型
	/////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////////
	///TKSParamsIDType是一个参数代码类型
	////////////////////////////////////////////////////////////////////////

	typedef char TKSParamsIDType[14];

	////////////////////////////////////////////////////////////////////////
	///TKSParamsNumType是一个参数代码值类型
	////////////////////////////////////////////////////////////////////////

	typedef char TKSParamsNumType[14];

	////////////////////////////////////////////////////////////////////////
	///TKSCustNameType是一个客户昵称类型
	////////////////////////////////////////////////////////////////////////

	typedef char TKSCustNameType[9];

	////////////////////////////////////////////////////////////////////////
	///TKSPswQuestionType是一个找回密码提问类型
	////////////////////////////////////////////////////////////////////////

	typedef char TKSPswQuestionType[41];

	////////////////////////////////////////////////////////////////////////
	///TKSPswAnswerType是一个找回密码回答类型
	////////////////////////////////////////////////////////////////////////

	typedef char TKSPswAnswerType[17];

	////////////////////////////////////////////////////////////////////////
	///TKSOrderPriceTypeType是一个报单价格条件类型
	////////////////////////////////////////////////////////////////////////
	///限价
	#define KSVOC_SOURCE_OPT_LimitPrice '0'
	///本方最优价(转撤销)
	#define KSVOC_SOURCE_OPT_BestPrice '9'
	///对手最优价(转限价)
	#define KSVOC_SOURCE_OPT_RivalBestPrice 'a'
	///最优五档剩余转撤销
	#define KSVOC_SOURCE_OPT_FiveLevelPriceTurnCancle 'b'
	///最优五档剩余转限价
	#define KSVOC_SOURCE_OPT_FiveLevelPriceTurnLimit 'c'
	///市价立即成交剩余即撤销
	#define KSVOC_SOURCE_OPT_MarketPriceForFAK 'd'
	///市价全成或全撤
	#define KSVOC_SOURCE_OPT_MarketPriceForFOK 'e'

	typedef char TKSOrderPriceTypeType;

	////////////////////////////////////////////////////////////////////////
	///TKSStkStatusFlagType是一个证券状态标志类型
	////////////////////////////////////////////////////////////////////////

	typedef char TKSStkStatusFlagType[33];

	////////////////////////////////////////////////////////////////////////
	///TKSStkTypeType是一个证券类别类型
	////////////////////////////////////////////////////////////////////////
	///凭证债券
	#define KSVOC_STK_CertificateBond "0"
	///其他债券
	#define KSVOC_STK_OtherBond "11"
	///国债回购
	#define KSVOC_STK_NationalBondBuyBack "22"
	///国债购回
	#define KSVOC_STK_NationalBondRepurchase "33"
	///投资基金
	#define KSVOC_STK_InvestmentFund "44"
	///ETF证券类别
	#define KSVOC_STK_ETF "45"
	///普通基金
	#define KSVOC_STK_Fund "55"
	///股票
	#define KSVOC_STK_Stock "66"
	///创业股票
	#define KSVOC_STK_VentureStock "67"
	///科创版股票
	#define KSVOC_STK_STARMarketStock "ww"

	typedef char TKSStkTypeType[3];

	////////////////////////////////////////////////////////////////////////
	///TKSMarketCodeType是一个市场代码类型
	////////////////////////////////////////////////////////////////////////
	///上海
	#define KSVOC_MC_SSE '1'
	///深圳
	#define KSVOC_MC_SZSE '2'

	typedef char TKSMarketCodeType;

	////////////////////////////////////////////////////////////////////////
	///TKSQryTypeType是一个查询条件类型
	////////////////////////////////////////////////////////////////////////
	///查当前记录
	#define KSVOC_QT_Current '0'
	///查历史记录
	#define KSVOC_QT_History '1'

	typedef char TKSQryTypeType;

	/////////////////////////////////////////////////////////////////////////
	///TKSExActionFlagType是一个购汇申请操作标志类型
	/////////////////////////////////////////////////////////////////////////
	///增加
	#define KSVOC_EAF_Add    '1'
	///撤销
	#define KSVOC_EAF_Delete '2'

	typedef char TKSExActionFlagType;

	/////////////////////////////////////////////////////////////////////////
	///TKSExchangeApplyStatusType是一个购汇申请状态类型
	/////////////////////////////////////////////////////////////////////////
	///未复核
	#define KSVOC_EAS_NotConfirm '0'
	///已撤销
	#define KSVOC_EAS_Canceled '1'
	///已复核
	#define KSVOC_EAS_Confirmed '2'
	///拒绝
	#define KSVOC_EAS_Rejected '3'

	typedef char TKSExchangeApplyStatusType;

	/////////////////////////////////////////////////////////////////////////
	///TFtdcTradeSystemTypeType是一个资金内转系统类型
	/////////////////////////////////////////////////////////////////////////
	///集中交易系统
#define KSOTP_ITS_CTrade '1'
	///融资融券交易系统
#define KSOTP_ITS_FTrade '7'
	///个股期权系统
#define KSOTP_ITS_OTP 'q'

	typedef char TThostFtdcInnerTransSystemType;

	/////////////////////////////////////////////////////////////////////////
	///TThostFtdcOTPIndexSeriesType是一个索引串类型
	/////////////////////////////////////////////////////////////////////////

	typedef char TThostFtdcIndexSeriesType[13];

	/////////////////////////////////////////////////////////////////////////
	///TThostFtdcOTPSerialNoType是一个流水号类型
	/////////////////////////////////////////////////////////////////////////
	typedef char TThostFtdcSerialNoType[13];

	/////////////////////////////////////////////////////////////////////////
	///TThostFtdcOTPVolumeType是一个数量类型
	/////////////////////////////////////////////////////////////////////////
	typedef int TThostFtdcVolumeType;

	/////////////////////////////////////////////////////////////////////////
	///TFtdcTradeSystemTypeType是一个处理标志类型
	/////////////////////////////////////////////////////////////////////////

	typedef char TThostFtdcDealFlag;

	/////////////////////////////////////////////////////////////////////////
	///TThostFtdcOTPSysRtnMsgType是一个返回信息类型
	/////////////////////////////////////////////////////////////////////////
	typedef char TThostFtdcSysRtnMsgType[256];

	/////////////////////////////////////////////////////////////////////////
	///TThostFtdcOTPSysRtnMsgType是一个委托方式类型
	/////////////////////////////////////////////////////////////////////////
	typedef char TThostFtdcWTStyleType[5];

	/////////////////////////////////////////////////////////////////////////
	///TThostFtdcOTPOperateStaffType是一个操作职工类型
	/////////////////////////////////////////////////////////////////////////
	typedef char TThostFtdcOperateStaffType[5];

	/////////////////////////////////////////////////////////////////////////
	///TThostFtdcOTPCurrencyIDType是一个币种代码类型
	/////////////////////////////////////////////////////////////////////////
	typedef char TThostFtdcCurrencyIDType[4];

	/////////////////////////////////////////////////////////////////////////
	///TThostFtdcOTPOperateStaffType是一个账户状态类型
	/////////////////////////////////////////////////////////////////////////
	typedef char TThostFtdcAccountStatusType[3];

	/////////////////////////////////////////////////////////////////////////
	///TThostFtdcOTPOperateStaffType是一个权限控制类型
	/////////////////////////////////////////////////////////////////////////
	typedef char TThostFtdcPrivilegeControlType[11];

	/////////////////////////////////////////////////////////////////////////
	///TThostFtdcOTPForbidInnerTransFlagType是一个禁止内转标志类型
	/////////////////////////////////////////////////////////////////////////
	///允许
#define KS_OTP_FITF_Allow '1'
	///禁止
#define KS_OTP_FITF_Forbid '0'

	typedef char TThostFtdcForbidInnerTransFlagType;
