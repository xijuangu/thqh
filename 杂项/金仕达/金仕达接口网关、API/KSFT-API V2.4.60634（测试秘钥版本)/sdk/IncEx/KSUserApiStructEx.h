...
namespace KingstarAPI
{
	...
	///国密用户登录请求
	struct CThostFtdcReqUserLoginSMField : public CThostFtdcReqUserLoginField
	{
		///认证码
		...
		//厂商信安新增如下几个字段
		//MAuth 服务标识 
		TThostFtdcAppIDType         MAuthServiceID;
		//MAuth AppID
		TThostFtdcAppIDType			MAuthAppID;
		//MAuth SecretKey 
		TThostFtdcSecretKeyType     MAuthSecretKey;
	...
	struct CThostFtdcTradeField
	{
		...
		TThostFtdcTradeSourceType	TradeSource;
		///组合持仓优先级别
		TThostFtdcPriorityLevelType PriorityLevel;
	};
	...
	struct CThostFtdcQryInstrumentField
	{
		...
		///产品代码
		TThostFtdcInstrumentIDType	ProductID;
		///每次取回的合约记录数（合约量大需分次查询情况下）
		TThostFtdcVolumeType  InstrumentNum;
	};
	...
	struct CThostFtdcInputQuoteField
	{
		...
		TThostFtdcMacAddressType	MacAddress;
		///报价系统号
		TThostFtdcOrderLocalIDType  QuoteSysID;
		///成交属性
		TThostFtdcTimeConditionType TimeCondition;
	...
	struct CThostFtdcCombActionField
	{
		...
		TThostFtdcPriorityLevelType PriorityLevel;
		///期权组合保证金比例
		TThostFtdcRatioType CombMarginRatio;
	};
	...
	///客户适当性评测结果查询
	struct CThostFtdcQryCustomerSuitableEvaResultsField
	{
		///经纪公司代码
		TThostFtdcBrokerIDType	BrokerID;
		///投资者代码
	...
	///适当性评测结果
	struct CThostFtdcCustomerSuitableEvaResultsField
	{
		///投资者代码
		TThostFtdcInvestorIDType	InvestorID;
		///有效期
		TThostFtdcDateType	ExpiryDate;
	};
	...
	///组保交易参数设置查询
	struct CThostFtdcQryPortfTradeParamSettingField
	{
		///交易所代码
		TThostFtdcExchangeIDType	ExchangeID;
		///经纪公司代码
	...
	struct CThostFtdcPortfTradeParamSettingField
	{
		...
		///客户名称
		TThostFtdcCSRCOpenInvestorNameType InvestorName;
		///交易编码
		TThostFtdcClientIDType ClientID;
	};
