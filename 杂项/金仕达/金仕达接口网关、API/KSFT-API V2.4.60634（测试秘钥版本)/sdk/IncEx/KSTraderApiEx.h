...
namespace KingstarAPI
{
	...
	public:
		...
		///组保交易参数设置查询
		virtual void OnRspQryPortfTradeParamSetting(CThostFtdcPortfTradeParamSettingField *pPortfTradeParamSetting, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};
	...
	public:
		...
		///获取API的版本信息
		///@return 获取到的版本号
		///@remark 若支持IPV6,版本号字符串附加格式IPV6=[<ipv6_address>]，与版本号间用逗号分隔，如"2.4.40115，IPV6=[fe80::f4a3:9570:8c6b:fdc2]"
		...
		///SPBM跨品种抵扣参数查询
		virtual int ReqQrySPBMInterParameter(CThostFtdcQrySPBMInterParameterField *pQrySPBMAddOnInterParameter, int nRequestID) = 0;

		///SPBM跨品种附加抵扣参数查询
		virtual int ReqQrySPBMAddOnInterParameter(CThostFtdcQrySPBMAddOnInterParameterField *pQrySPBMInterParameter, int nRequestID) = 0;
		...
		///组保交易参数设置查询
		virtual int ReqQryPortfTradeParamSetting(CThostFtdcQryPortfTradeParamSettingField *pQryPortfTradeParamSetting, int nRequestID) = 0;
