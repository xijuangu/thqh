...
namespace KingstarAPI
{
	...
	public:
		...
		///请求查询组合保证金率响应
		virtual void OnRspQryCombInstrumentMarginRate(CKSCombInstrumentMarginRateField *pCombInstrumentMarginRateField, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){};
		...
		///客户购汇申请响应
		virtual void OnRspExchangeApply(CKSInputExchangeApplyField *pInputExchangeApply, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

		///客户购汇申请查询响应
		virtual void OnRspQryExchangeApply(CKSRspQryExchangeApplyField *pQryExchangeApply, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

		///当日换汇额度查询响应
		virtual void OnRspQryExchangeCredit(CKSRspQryExchangeCreditField *pQryExchangeCredit, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};
	
		///适当性查询响应
		virtual void OnRspQryCustomerSuitableEvaResults(CThostFtdcCustomerSuitableEvaResultsField *pCustomerSuitableEvaResults, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};
		...
		///投资者SPMM组合优惠分类参数查询响应
		virtual void OnRspQryInvestorSPMMCombDiscountParam(CKSInvestorSPMMCombDiscountParamField *pInvestorSPMMCombDiscountParam, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

		///投资者RULE明细查询响应
		virtual void OnRspQryInvestorProdRULEDetail(CKSInvestorProdRULEDetailField *pInvestorProdRULEDetail, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};
	...
	public:
		...
		///请求查询组合保证金率
		virtual int ReqQryCombInstrumentMarginRate(CKSQryCombInstrumentMarginRateField *pQryCombInstrumentMarginRate, int nRequestID) = 0;
		...
		///客户购汇申请
		virtual int ReqExchangeApply(CKSInputExchangeApplyField *pInputExchangeApply, int nRequestID) = 0;

		///客户购汇申请查询
		virtual int ReqQryExchangeApply(CKSQryExchangeApplyField *pQryExchangeApply, int nRequestID) = 0;

		///当日换汇额度查询
		virtual int ReqQryExchangeCredit(CKSQryExchangeCreditField *pQryExchangeCredit, int nRequestID) = 0;

		///适当性查询
		virtual int ReqQryCustomerSuitableEvaResults(CThostFtdcQryCustomerSuitableEvaResultsField *pQryCustomerSuitableEvaResults, int nRequestID) = 0;

		///出入金查询
		virtual int ReqQryDepositAndWithdraw(CKSQryDepositAndWithdrawField *pQryDepositAndWithdraw, int nRequestID) = 0;

		///投资者新型组合保证金系数查询带交易编码
		virtual int ReqQryInvestorPortfMarginRatioAddClientID(CKSQryInvestorPortfMarginRatioAddClientIDField *pQryInvestorPortfMarginRatioAddClientID, int nRequestID) = 0;

		///投资者SPMM组合优惠分类参数查询
		virtual int ReqQryInvestorSPMMCombDiscountParam(CKSQryInvestorSPMMCombDiscountParamField *QryInvestorSPMMCombDiscountParam, int nRequestID) = 0;

		///投资者RULE明细查询请求
		virtual int ReqQryInvestorProdRULEDetail(CKSQryInvestorProdRULEDetailField *pQryInvestorProdRULEDetail, int nRequestID) = 0;
