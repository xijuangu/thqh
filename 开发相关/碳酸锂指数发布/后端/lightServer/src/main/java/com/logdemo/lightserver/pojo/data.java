...
public class data {
    ...
    private Double spodumene; // 锂辉石
    private Double Lg_Lepidolite; // 低品位锂云母
    private Double Hg_Lepidolite; //高品味锂云母
    private Double LFP_Cathode; // 磷酸铁锂正极片
    private Double LFP_BattPower; // 磷酸铁锂电池粉
    private Double NCM; // 三元极片粉
    private Double ECSpot; // 电碳现货价
    private Double CompoIndex; // 综合指数
    ...
    public Double getCompoIndex() {
        return CompoIndex;
    }

    public void setCompoIndex(Double compoIndex) {
